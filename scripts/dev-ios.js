...
try {
  execSync(`cross-env ${envVars} ENVIRONMENT=ios EXTERNAL_API_HOST=$(osascript -e \"IPv4 address of (system info)\") vite --force --host=$EXTERNAL_API_HOST --port 3004`, { stdio: 'inherit' });
} catch (error) {
